...
public class PermissionUtils {
    ...
    private static boolean checkCallingObjectSuitability(Object object) {
        if (object == null) {
            Log.e("PermissionUtils", new NullPointerException("Activity or Fragment should not be null").toString());
            return false;
        }
        ...
        if (!(isActivity || isSupportFragment || isAppFragment)) {
            Log.e("PermissionUtils", new IllegalArgumentException("Caller must be an Activity or a Fragment").toString());
            return false;
        }
        return true;
    }
